                                ...
                                <div>
                                    @php
                                        $user = DB::table('users')
                                            ...
                                            ->get();
                                    @endphp
                                    <select multiple name="recipents[]" placeholder="Select Recipents"
                                        data-search="false" data-silent-initial-value-set="true" id="edit_recipents">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="group-input">
                                                ...
                                                <datalist id="batches">
                                                    <option value="Document Identification">Document Identification
                                                    </option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="group-input">
                                                ...
                                                @php
                                                    $user = DB::table('users')->where('role', 4)->get();
                                                @endphp
                ...
                <div class="content-container">
                    <form action="#" method="post">
                        <div class="division-tabs">
                            <div class="tab">
                                <div class="divisionlinks active" onclick="openDivision(event, 'qms-apac')">QMS - APAC
                                </div>
                                <div class="divisionlinks" onclick="openDivision(event, 'qms-emea')">QMS - EMEA</div>
                                <div class="divisionlinks" onclick="openDivision(event, 'qms-north')">QMS - North America
                                </div>
                                ...
                                <div class="divisionlinks" onclick="openDivision(event, 'dms-south')">DMS - South Korea
                                </div>
                                <div class="divisionlinks" onclick="openDivision(event, 'dms-north')">DMS - North America
                                </div>
    ...
    crossorigin="anonymous" referrerpolicy="no-referrer"></script>
        ...
        <script>
            ...
            var options = {
                ...
                xaxis: {
                    categories: ['Assigned', 'Completed', 'Unassigned', 'Not Completed', 'In Process', 'Document Obsoleted',
                        'Course Obsoleted',
